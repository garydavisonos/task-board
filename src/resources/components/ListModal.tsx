                ...
                <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
                    <fieldset className='flex flex-col gap-2'>
                        ...
                        <label className='text-sm'>
                            Label
                            <input className="text-sm border border-gray-400 p-2 w-full" name="label" type="text" onChange={event => setListLabel(event.target.value)} />
                        </label>
                        <input type="submit" value="Submit" className="button ml-auto mt-2" />
                    </fieldset>
                </form>
